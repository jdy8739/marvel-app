...
function Comics() {
	...
	return (
		<>
			...
			>
				<Btn onClick={fetchFirst}>first</Btn>
				<Btn onClick={fetchPrevious} disabled={+nowPage === 0}>
					prev
				</Btn>
				...
				<Btn onClick={fetchNext} disabled={+nowPage >= TOTAL / LIMIT}>
					next
				</Btn>
				<Btn onClick={fetchLast}>last</Btn>
			</div>
			<AnimatePresence>
